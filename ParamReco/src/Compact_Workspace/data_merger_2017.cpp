...
int main(){
	...
	merged_file.open("Merged_data_2017_PedSub1+4.txt"); // tab separated 
	...
	params_ss << "data/XTAL_Params_2017_copy.txt"; // (ID, A, t0, alpha, beta) values	
	weights_ss << "data/PedSub1+4_2017_copy.txt"; // (ID, weights)

...
int main()
{
	...
	total_error_title << max_rows << " XTALS per ts";	

  	TString total_error_title_ = total_error_title.str(); 
	TH1F *Ets = new TH1F("Ets",total_error_title_,10,-5,5); // Name is used to access after saving
	...
	Ets->GetXaxis()->SetTitleOffset(1.1);

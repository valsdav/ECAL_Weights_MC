...
void phi_reco(){
  ...
  TString phititle_(phititle.str());
...
////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //cout << "phiamp["<<iphicounter<<"] = " << phiamp[iphicounter] << "\n" << endl;
...
////////////////////////////////////////////////////////////////////////////////////////////
  ...
  for (Int_t i = 0; i < 360; i++){
    ...
    phiamp[i] = phiamp[i] / 170; // average over eta
    //cout << "phiamp[" << i << "] = " << phiamp[i] << "\n" << endl;
    //cout << "phivalues[" << i << "] = " << phivalues[i] << "\n" << endl;

    }

  Int_t num = 360;

  TGraph* gr = new TGraph(num,phivalues,phiamp); //Int_t, double, double
  gr->GetYaxis()->SetRangeUser(0.9,1.1);
  gr->GetXaxis()->SetRangeUser(0,360);
  gr->SetTitle(phititle_);
  gr->SetMarkerColor(1);
  gr->SetMarkerStyle(8);
  gr->SetMarkerSize(1);

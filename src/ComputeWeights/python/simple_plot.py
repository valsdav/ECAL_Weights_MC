...
for i in paths:
	...
	# This resets every file
	all_rows = [[],[],[]] # [[raw],[samples],[weights]]
	...
	# Import data file
	with open(i, 'r') as f: # Create file object f by opening file path 'i' in read mode.
	...
	for k in range(len(all_rows[2][0])):
		amplitude += float(all_rows[2][0][k]) * float(all_rows[1][0][k])
	print 'ampltiude = ',amplitude 

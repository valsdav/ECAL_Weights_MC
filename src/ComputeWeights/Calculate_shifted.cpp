...
int main() {
  ...
  std::string file = "/Users/meganstark/Computation*/PHYS7321_Project/Data/norm_template_histograms_ECAL_Run2016_runs_274958_275659.txt" ;
/*
  ...
  */
  ...
  while(std::getline(inFile, line)) {
    ...
    if(s >> d1 >> d2 >> d3 >> d4 >> d5 >> d6 >> d7 >> d8 >> d9 >> d10 >> d11 >> d12 >> d13 >> d14) {
      ...
      pulseShape.push_back(0-shift);
      pulseShape.push_back(0-shift);
      pulseShape.push_back(0-shift);
      //pulseShape.push_back(d1);
      //pulseShape.push_back(d2);
      pulseShape.push_back(d3-shift);
      pulseShape.push_back(d4-shift);
      pulseShape.push_back(d5-shift);
      pulseShape.push_back(d6-shift);
      pulseShape.push_back(d7-shift);
      pulseShape.push_back(d8-shift);
      pulseShape.push_back(d9-shift);
    ...
    // dummy pulse shape derivative
      ...
      //cout << pulseShapeDerivative << endl;

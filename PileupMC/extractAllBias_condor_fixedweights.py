...
parser.add_argument("--byer", action="store_true", default=False, help="Group weights by eta ring", required=False)
parser.add_argument("--byendcap", action="store_true", default=False, help="Use global mean of weights", required=False)
...
if args.byendcap:
    # do a global mean of the weights and encode them

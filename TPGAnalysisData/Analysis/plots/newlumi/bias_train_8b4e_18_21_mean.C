...
//=========  (Tue Aug 20 10:22:20 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.7415662,-0.4454366,8.535542,1.117792);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_gr_pu0_8b4e_18_21_bias_train_mean12->SetMinimum(-0.172654);
   Graph_gr_pu0_8b4e_18_21_bias_train_mean12->SetMaximum(0.217738);
   ...
   Graph_gr_pu0_newavg_8b4e_18_21_bias_train_mean13->SetMinimum(-0.1737021);
   Graph_gr_pu0_newavg_8b4e_18_21_bias_train_mean13->SetMaximum(0.2041203);
   ...
   Graph_gr_pu50s2_8b4e_18_21_bias_train_mean14->SetMinimum(-0.1453347);
   Graph_gr_pu50s2_8b4e_18_21_bias_train_mean14->SetMaximum(0.2231062);
   ...
   Graph_gr_pu50s30_8b4e_18_21_bias_train_mean15->SetMinimum(-0.1577935);
   Graph_gr_pu50s30_8b4e_18_21_bias_train_mean15->SetMaximum(0.2156339);

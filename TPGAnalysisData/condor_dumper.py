...
parser.add_argument("-i", "--inputfiles",nargs="+", type=str, help="inputfiles", required=True)
...
cp -r {cmssw_loc} .
cd {cmssw_file}/src/EcalTPGAnalysis/Scripts/TriggerAnalysis
...
for inputfile in args.inputfiles:
    for ws in args.weights_sets:
            ...
            arguments.append("{} {} {} {}".format(
                outputfile, inputfile, weights_idmap, weights_group))

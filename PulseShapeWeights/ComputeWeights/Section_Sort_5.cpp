...
void Section_Sort_5(int max_sections, int max_lines, string PD, string WC, string note){
	...
	//////////////////////////////////
			...
			//if (WC == "2"){
				...
				if ( (EE_line == SP1) ){ //&& (DOF1 == SP2) ){
					...
					//if ( (section_pop == 1700 && SP1 == 0) && (section_pop == 7900 && SP1 == 1) ){ // EB SM full, or EE iz full. 
					if ( (section_pop == 61000 && SP1 == 0) && (section_pop == 15000 && SP1 == 1) ){ // EB is full, or EE is full. Overestimating to be safe. 

						//cout << "Section " << SP1 << "_" << SP2 << "_" << SP3 << "_" << SP4 << " is full\n";
						cout << "Section " << SP1 << " is full\n";
				...
				if ( inDOFPFile.tellg() == DOFP_length ){ 
						...
						cout << "\tDefining section " << SP1 << endl;
						// Add ID

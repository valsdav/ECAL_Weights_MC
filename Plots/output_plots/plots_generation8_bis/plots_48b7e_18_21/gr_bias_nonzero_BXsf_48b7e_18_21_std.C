void gr_bias_nonzero_BXsf_48b7e_18_21_std()
{
...
//=========  (Wed Jul  3 00:04:00 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.9903614,-0.06527401,9.612048,0.4368338);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_nonzero_BXsf_std66->SetMinimum(0.009127964);
   Graph_curr_48b7e_gr_bias_nonzero_BXsf_std66->SetMaximum(0.4306091);
   ...
   Graph_pu0_48b7e_gr_bias_nonzero_BXsf_std67->SetMinimum(0.004962439);
   Graph_pu0_48b7e_gr_bias_nonzero_BXsf_std67->SetMaximum(0.4239987);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_BXsf_std68->SetMinimum(0.008102808);
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_BXsf_std68->SetMaximum(0.4065196);
   ...
   Graph_pu50s2_48b7e_gr_bias_nonzero_BXsf_std69->SetMinimum(0.009022201);
   Graph_pu50s2_48b7e_gr_bias_nonzero_BXsf_std69->SetMaximum(0.4169291);
   ...
   Graph_pu50s30_48b7e_gr_bias_nonzero_BXsf_std70->SetMinimum(0.005202116);
   Graph_pu50s30_48b7e_gr_bias_nonzero_BXsf_std70->SetMaximum(0.4237099);

void gr_bias_totsf_48b7e_18_21_std()
{
...
//=========  (Wed Jul  3 00:08:45 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.9903614,-0.1936717,9.612048,1.296111);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_totsf_std36->SetMinimum(0.009301432);
   Graph_curr_48b7e_gr_bias_totsf_std36->SetMaximum(1.274725);
   ...
   Graph_pu0_48b7e_gr_bias_totsf_std37->SetMinimum(0.005234513);
   Graph_pu0_48b7e_gr_bias_totsf_std37->SetMaximum(1.279517);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_totsf_std38->SetMinimum(0.007320802);
   Graph_pu0_newavg_48b7e_gr_bias_totsf_std38->SetMaximum(1.243443);
   ...
   Graph_pu50s2_48b7e_gr_bias_totsf_std39->SetMinimum(0.008828649);
   Graph_pu50s2_48b7e_gr_bias_totsf_std39->SetMaximum(1.254144);
   ...
   Graph_pu50s30_48b7e_gr_bias_totsf_std40->SetMinimum(0.005465918);
   Graph_pu50s30_48b7e_gr_bias_totsf_std40->SetMaximum(1.277413);

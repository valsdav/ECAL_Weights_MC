void gr_bias_nonzero_totsf_48b7e_18_21_mean()
{
...
//=========  (Wed Jul  3 00:04:00 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.9903614,-0.1041905,9.612048,0.3010419);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_nonzero_totsf_mean71->SetMinimum(-0.05212358);
   Graph_curr_48b7e_gr_bias_nonzero_totsf_mean71->SetMaximum(0.291715);
   ...
   Graph_pu0_48b7e_gr_bias_nonzero_totsf_mean72->SetMinimum(-0.06465736);
   Graph_pu0_48b7e_gr_bias_nonzero_totsf_mean72->SetMaximum(0.2743565);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_totsf_mean73->SetMinimum(-0.0272798);
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_totsf_mean73->SetMaximum(0.2892275);
   ...
   Graph_pu50s2_48b7e_gr_bias_nonzero_totsf_mean74->SetMinimum(-0.03551384);
   Graph_pu50s2_48b7e_gr_bias_nonzero_totsf_mean74->SetMaximum(0.2930571);
   ...
   Graph_pu50s30_48b7e_gr_bias_nonzero_totsf_mean75->SetMinimum(-0.06231499);
   Graph_pu50s30_48b7e_gr_bias_nonzero_totsf_mean75->SetMaximum(0.2761765);

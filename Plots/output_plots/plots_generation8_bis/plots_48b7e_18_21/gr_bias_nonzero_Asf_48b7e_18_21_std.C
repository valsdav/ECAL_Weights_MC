void gr_bias_nonzero_Asf_48b7e_18_21_std()
{
...
//=========  (Wed Jul  3 00:03:59 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.9903614,-0.06949307,9.612048,0.465069);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_nonzero_Asf_std56->SetMinimum(0.009298176);
   Graph_curr_48b7e_gr_bias_nonzero_Asf_std56->SetMaximum(0.4584858);
   ...
   Graph_pu0_48b7e_gr_bias_nonzero_Asf_std57->SetMinimum(0.005234821);
   Graph_pu0_48b7e_gr_bias_nonzero_Asf_std57->SetMaximum(0.4478305);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_Asf_std58->SetMinimum(0.007317217);
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_Asf_std58->SetMaximum(0.4297928);
   ...
   Graph_pu50s2_48b7e_gr_bias_nonzero_Asf_std59->SetMinimum(0.008823226);
   Graph_pu50s2_48b7e_gr_bias_nonzero_Asf_std59->SetMaximum(0.4423411);
   ...
   Graph_pu50s30_48b7e_gr_bias_nonzero_Asf_std60->SetMinimum(0.0054651);
   Graph_pu50s30_48b7e_gr_bias_nonzero_Asf_std60->SetMaximum(0.4477875);

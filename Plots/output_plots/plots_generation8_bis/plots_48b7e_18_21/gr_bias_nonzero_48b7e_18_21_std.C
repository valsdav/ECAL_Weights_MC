void gr_bias_nonzero_48b7e_18_21_std()
{
//=========Macro generated from canvas: c2/c2
//=========  (Wed Jul  3 00:03:58 2019) by ROOT version 6.16/00
   TCanvas *c2 = new TCanvas("c2", "c2",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c2->SetHighLightColor(2);
   c2->Range(-0.9903614,-0.06400071,9.612048,0.4283124);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_nonzero_std46->SetMinimum(0.0091255);
   Graph_curr_48b7e_gr_bias_nonzero_std46->SetMaximum(0.4221953);
   ...
   Graph_pu0_48b7e_gr_bias_nonzero_std47->SetMinimum(0.004962861);
   Graph_pu0_48b7e_gr_bias_nonzero_std47->SetMaximum(0.4157245);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_std48->SetMinimum(0.008098248);
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_std48->SetMaximum(0.3977943);
   ...
   Graph_pu50s2_48b7e_gr_bias_nonzero_std49->SetMinimum(0.009017068);
   Graph_pu50s2_48b7e_gr_bias_nonzero_std49->SetMaximum(0.4083302);
   ...
   Graph_pu50s30_48b7e_gr_bias_nonzero_std50->SetMinimum(0.005202672);
   Graph_pu50s30_48b7e_gr_bias_nonzero_std50->SetMaximum(0.4154304);
   ...
   entry->SetMarkerSize(0.6);
   entry->SetTextFont(62);
   entry=leg->AddEntry("pu50s2_48b7e_gr_bias_nonzero_mean","#splitline{PU optimized}{(PU=50, ET=2GeV)}","lp");
   ...
   entry->SetMarkerSize(0.6);
   entry->SetTextFont(62);
   entry=leg->AddEntry("pu50s30_48b7e_gr_bias_nonzero_mean","#splitline{PU optimized}{(PU=50, ET=30GeV)}","lp");

void gr_bias_nonzero_BXsf_48b7e_26_28_mean()
{
...
//=========  (Wed Jul  3 00:46:37 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.9903614,-0.3773967,9.612048,1.233637);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_nonzero_BXsf_mean61->SetMinimum(-0.07088738);
   Graph_curr_48b7e_gr_bias_nonzero_BXsf_mean61->SetMaximum(0.3876295);
   ...
   Graph_pu0_48b7e_gr_bias_nonzero_BXsf_mean62->SetMinimum(-0.1016092);
   Graph_pu0_48b7e_gr_bias_nonzero_BXsf_mean62->SetMaximum(0.302153);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_BXsf_mean63->SetMinimum(-0.05375718);
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_BXsf_mean63->SetMaximum(0.369507);
   ...
   Graph_pu50s2_48b7e_gr_bias_nonzero_BXsf_mean64->SetMinimum(0.0126831);
   Graph_pu50s2_48b7e_gr_bias_nonzero_BXsf_mean64->SetMaximum(0.2867509);
   ...
   Graph_pu50s30_48b7e_gr_bias_nonzero_BXsf_mean65->SetMinimum(-0.08826246);
   Graph_pu50s30_48b7e_gr_bias_nonzero_BXsf_mean65->SetMaximum(0.3138548);

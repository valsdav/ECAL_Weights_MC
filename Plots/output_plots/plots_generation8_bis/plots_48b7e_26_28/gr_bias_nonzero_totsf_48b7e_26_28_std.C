void gr_bias_nonzero_totsf_48b7e_26_28_std()
{
...
//=========  (Wed Jul  3 00:46:38 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.9903614,-0.1711254,9.612048,1.145224);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_nonzero_totsf_std76->SetMinimum(0.01188491);
   Graph_curr_48b7e_gr_bias_nonzero_totsf_std76->SetMaximum(1.130013);
   ...
   Graph_pu0_48b7e_gr_bias_nonzero_totsf_std77->SetMinimum(0.009059725);
   Graph_pu0_48b7e_gr_bias_nonzero_totsf_std77->SetMaximum(1.083531);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_totsf_std78->SetMinimum(0.01053558);
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_totsf_std78->SetMaximum(1.12918);
   ...
   Graph_pu50s2_48b7e_gr_bias_nonzero_totsf_std79->SetMinimum(0.0180622);
   Graph_pu50s2_48b7e_gr_bias_nonzero_totsf_std79->SetMaximum(0.9386956);
   ...
   Graph_pu50s30_48b7e_gr_bias_nonzero_totsf_std80->SetMinimum(0.009380336);
   Graph_pu50s30_48b7e_gr_bias_nonzero_totsf_std80->SetMaximum(1.088413);

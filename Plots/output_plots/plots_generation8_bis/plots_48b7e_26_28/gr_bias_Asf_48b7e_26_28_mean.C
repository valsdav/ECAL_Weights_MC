void gr_bias_Asf_48b7e_26_28_mean()
{
...
//=========  (Wed Jul  3 00:46:32 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.9903614,-0.6297264,9.612048,0.5137645);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_Asf_mean11->SetMinimum(-0.3753425);
   Graph_curr_48b7e_gr_bias_Asf_mean11->SetMaximum(0.06515069);
   ...
   Graph_pu0_48b7e_gr_bias_Asf_mean12->SetMinimum(-0.418754);
   Graph_pu0_48b7e_gr_bias_Asf_mean12->SetMaximum(0.03342257);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_Asf_mean13->SetMinimum(-0.3874323);
   Graph_pu0_newavg_48b7e_gr_bias_Asf_mean13->SetMaximum(0.09090335);
   ...
   Graph_pu50s2_48b7e_gr_bias_Asf_mean14->SetMinimum(-0.418271);
   Graph_pu50s2_48b7e_gr_bias_Asf_mean14->SetMaximum(0.1889635);
   ...
   Graph_pu50s30_48b7e_gr_bias_Asf_mean15->SetMinimum(-0.4094482);
   Graph_pu50s30_48b7e_gr_bias_Asf_mean15->SetMaximum(0.04854558);

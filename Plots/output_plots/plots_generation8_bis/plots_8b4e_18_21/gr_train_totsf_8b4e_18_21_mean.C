void gr_train_totsf_8b4e_18_21_mean()
{
//=========Macro generated from canvas: c1/c1
//=========  (Wed Jul  3 00:04:53 2019) by ROOT version 6.16/00
   TCanvas *c1 = new TCanvas("c1", "c1",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->SetHighLightColor(2);
   c1->Range(-0.7415662,-0.3395225,8.535542,1.502959);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_train_totsf_mean111->SetMinimum(0.02225794);
   Graph_curr_8b4e_gr_train_totsf_mean111->SetMaximum(0.4640801);
   ...
   Graph_pu0_8b4e_gr_train_totsf_mean112->SetMinimum(0.01642283);
   Graph_pu0_8b4e_gr_train_totsf_mean112->SetMaximum(0.4428605);
   ...
   Graph_pu0_newavg_8b4e_gr_train_totsf_mean113->SetMinimum(0.02593568);
   Graph_pu0_newavg_8b4e_gr_train_totsf_mean113->SetMaximum(0.462425);
   ...
   Graph_pu50s2_8b4e_gr_train_totsf_mean114->SetMinimum(0.0047336);
   Graph_pu50s2_8b4e_gr_train_totsf_mean114->SetMaximum(0.4659612);
   ...
   Graph_pu50s30_8b4e_gr_train_totsf_mean115->SetMinimum(0.0181706);
   Graph_pu50s30_8b4e_gr_train_totsf_mean115->SetMaximum(0.4450315);

void gr_train_Asf_8b4e_18_21_mean()
{
...
//=========  (Wed Jul  3 00:04:47 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.7415662,-0.3359371,8.535542,1.478964);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_train_Asf_mean91->SetMinimum(0.03028598);
   Graph_curr_8b4e_gr_train_Asf_mean91->SetMaximum(0.4551939);
   ...
   Graph_pu0_8b4e_gr_train_Asf_mean92->SetMinimum(0.02451451);
   Graph_pu0_8b4e_gr_train_Asf_mean92->SetMaximum(0.4341497);
   ...
   Graph_pu0_newavg_8b4e_gr_train_Asf_mean93->SetMinimum(0.0358653);
   Graph_pu0_newavg_8b4e_gr_train_Asf_mean93->SetMaximum(0.4544032);
   ...
   Graph_pu50s2_8b4e_gr_train_Asf_mean94->SetMinimum(0.0146774);
   Graph_pu50s2_8b4e_gr_train_Asf_mean94->SetMaximum(0.4575809);
   ...
   Graph_pu50s30_8b4e_gr_train_Asf_mean95->SetMinimum(0.02623255);
   Graph_pu50s30_8b4e_gr_train_Asf_mean95->SetMaximum(0.436339);

void gr_bias_nonzero_8b4e_22_25_mean()
{
//=========Macro generated from canvas: c1/c1
//=========  (Wed Jul  3 00:04:30 2019) by ROOT version 6.16/00
   TCanvas *c1 = new TCanvas("c1", "c1",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->SetHighLightColor(2);
   c1->Range(-0.4927711,-0.2420082,7.459036,0.8012248);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_nonzero_mean41->SetMinimum(0.0004877547);
   Graph_curr_8b4e_gr_bias_nonzero_mean41->SetMaximum(0.2353696);
   ...
   Graph_pu0_8b4e_gr_bias_nonzero_mean42->SetMinimum(-0.02438807);
   Graph_pu0_8b4e_gr_bias_nonzero_mean42->SetMaximum(0.1916135);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_mean43->SetMinimum(0.02486385);
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_mean43->SetMaximum(0.2168972);
   ...
   Graph_pu50s2_8b4e_gr_bias_nonzero_mean44->SetMinimum(0.05164219);
   Graph_pu50s2_8b4e_gr_bias_nonzero_mean44->SetMaximum(0.2429294);
   ...
   Graph_pu50s30_8b4e_gr_bias_nonzero_mean45->SetMinimum(-0.01938049);
   Graph_pu50s30_8b4e_gr_bias_nonzero_mean45->SetMaximum(0.1964506);

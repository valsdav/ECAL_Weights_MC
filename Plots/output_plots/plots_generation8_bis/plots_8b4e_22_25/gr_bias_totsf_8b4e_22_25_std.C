void gr_bias_totsf_8b4e_22_25_std()
{
...
//=========  (Wed Jul  3 00:04:29 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.4927711,-0.1997053,7.459036,1.336489);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_totsf_std36->SetMinimum(0.02076188);
   Graph_curr_8b4e_gr_bias_totsf_std36->SetMaximum(1.307077);
   ...
   Graph_pu0_8b4e_gr_bias_totsf_std37->SetMinimum(0.01831297);
   Graph_pu0_8b4e_gr_bias_totsf_std37->SetMaximum(1.318695);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_totsf_std38->SetMinimum(0.01898318);
   Graph_pu0_newavg_8b4e_gr_bias_totsf_std38->SetMaximum(1.301376);
   ...
   Graph_pu50s2_8b4e_gr_bias_totsf_std39->SetMinimum(0.02494001);
   Graph_pu50s2_8b4e_gr_bias_totsf_std39->SetMaximum(1.275234);
   ...
   Graph_pu50s30_8b4e_gr_bias_totsf_std40->SetMinimum(0.01841043);
   Graph_pu50s30_8b4e_gr_bias_totsf_std40->SetMaximum(1.316047);

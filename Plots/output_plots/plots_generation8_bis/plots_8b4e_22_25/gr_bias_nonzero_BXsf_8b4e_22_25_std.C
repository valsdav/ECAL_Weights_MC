void gr_bias_nonzero_BXsf_8b4e_22_25_std()
{
...
//=========  (Wed Jul  3 00:04:32 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.4927711,-0.07366592,7.459036,0.492995);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_nonzero_BXsf_std66->SetMinimum(0.01799417);
   Graph_curr_8b4e_gr_bias_nonzero_BXsf_std66->SetMaximum(0.4856705);
   ...
   Graph_pu0_8b4e_gr_bias_nonzero_BXsf_std67->SetMinimum(0.01513936);
   Graph_pu0_8b4e_gr_bias_nonzero_BXsf_std67->SetMaximum(0.4746198);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_BXsf_std68->SetMinimum(0.01615145);
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_BXsf_std68->SetMaximum(0.4769845);
   ...
   Graph_pu50s2_8b4e_gr_bias_nonzero_BXsf_std69->SetMinimum(0.02307351);
   Graph_pu50s2_8b4e_gr_bias_nonzero_BXsf_std69->SetMaximum(0.4540636);
   ...
   Graph_pu50s30_8b4e_gr_bias_nonzero_BXsf_std70->SetMinimum(0.01529514);
   Graph_pu50s30_8b4e_gr_bias_nonzero_BXsf_std70->SetMaximum(0.473837);

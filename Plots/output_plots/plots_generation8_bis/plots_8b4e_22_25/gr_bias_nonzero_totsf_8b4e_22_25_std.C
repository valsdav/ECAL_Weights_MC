void gr_bias_nonzero_totsf_8b4e_22_25_std()
{
...
//=========  (Wed Jul  3 00:04:35 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.4927711,-0.08592344,7.459036,0.5750261);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_nonzero_totsf_std76->SetMinimum(0.02070316);
   Graph_curr_8b4e_gr_bias_nonzero_totsf_std76->SetMaximum(0.5665488);
   ...
   Graph_pu0_8b4e_gr_bias_nonzero_totsf_std77->SetMinimum(0.01824818);
   Graph_pu0_8b4e_gr_bias_nonzero_totsf_std77->SetMaximum(0.5481953);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_totsf_std78->SetMinimum(0.01894001);
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_totsf_std78->SetMaximum(0.5625991);
   ...
   Graph_pu50s2_8b4e_gr_bias_nonzero_totsf_std79->SetMinimum(0.02489893);
   Graph_pu50s2_8b4e_gr_bias_nonzero_totsf_std79->SetMaximum(0.5319181);
   ...
   Graph_pu50s30_8b4e_gr_bias_nonzero_totsf_std80->SetMinimum(0.01834667);
   Graph_pu50s30_8b4e_gr_bias_nonzero_totsf_std80->SetMaximum(0.5478797);

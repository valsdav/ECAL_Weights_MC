void gr_bias_nonzero_8b4e_22_25_std()
{
...
//=========  (Wed Jul  3 00:04:30 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.4927711,-0.08007174,7.459036,0.5358647);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_nonzero_std46->SetMinimum(0.0168996);
   Graph_curr_8b4e_gr_bias_nonzero_std46->SetMaximum(0.5280411);
   ...
   Graph_pu0_8b4e_gr_bias_nonzero_std47->SetMinimum(0.01374705);
   Graph_pu0_8b4e_gr_bias_nonzero_std47->SetMaximum(0.5139258);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_std48->SetMinimum(0.0150088);
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_std48->SetMaximum(0.5054518);
   ...
   Graph_pu50s2_8b4e_gr_bias_nonzero_std49->SetMinimum(0.02280519);
   Graph_pu50s2_8b4e_gr_bias_nonzero_std49->SetMaximum(0.4907314);
   ...
   Graph_pu50s30_8b4e_gr_bias_nonzero_std50->SetMinimum(0.01398057);
   Graph_pu50s30_8b4e_gr_bias_nonzero_std50->SetMaximum(0.5130571);

void gr_bias_totsf_8b4e_22_25_mean()
{
...
//=========  (Wed Jul  3 00:04:29 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.4927711,-0.1863621,7.459036,0.4092334);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_totsf_mean31->SetMinimum(0.009437203);
   Graph_curr_8b4e_gr_bias_totsf_mean31->SetMaximum(0.09943936);
   ...
   Graph_pu0_8b4e_gr_bias_totsf_mean32->SetMinimum(-0.01412784);
   Graph_pu0_8b4e_gr_bias_totsf_mean32->SetMaximum(0.04818997);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_totsf_mean33->SetMinimum(0.03226707);
   Graph_pu0_newavg_8b4e_gr_bias_totsf_mean33->SetMaximum(0.07231311);
   ...
   Graph_pu50s2_8b4e_gr_bias_totsf_mean34->SetMinimum(0.06124525);
   Graph_pu50s2_8b4e_gr_bias_totsf_mean34->SetMaximum(0.1198715);
   ...
   Graph_pu50s30_8b4e_gr_bias_totsf_mean35->SetMinimum(-0.009312488);
   Graph_pu50s30_8b4e_gr_bias_totsf_mean35->SetMaximum(0.05486612);

...
//=========  (Wed Jul  3 00:04:27 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.4927711,-0.1674552,7.459036,1.120662);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_std6->SetMinimum(0.01693316);
   Graph_curr_8b4e_gr_bias_std6->SetMaximum(1.105323);
   ...
   Graph_pu0_8b4e_gr_bias_std7->SetMinimum(0.0137836);
   Graph_pu0_8b4e_gr_bias_std7->SetMaximum(1.105825);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_std8->SetMinimum(0.01503545);
   Graph_pu0_newavg_8b4e_gr_bias_std8->SetMaximum(1.077067);
   ...
   Graph_pu50s2_8b4e_gr_bias_std9->SetMinimum(0.02282454);
   Graph_pu50s2_8b4e_gr_bias_std9->SetMaximum(1.068174);
   ...
   Graph_pu50s30_8b4e_gr_bias_std10->SetMinimum(0.01401679);
   Graph_pu50s30_8b4e_gr_bias_std10->SetMaximum(1.104334);

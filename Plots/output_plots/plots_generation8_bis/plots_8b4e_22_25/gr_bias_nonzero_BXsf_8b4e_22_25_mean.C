void gr_bias_nonzero_BXsf_8b4e_22_25_mean()
{
...
//=========  (Wed Jul  3 00:04:32 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.4927711,-0.2325546,7.459036,0.7249487);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_nonzero_BXsf_mean61->SetMinimum(0.001794522);
   Graph_curr_8b4e_gr_bias_nonzero_BXsf_mean61->SetMaximum(0.1997423);
   ...
   Graph_pu0_8b4e_gr_bias_nonzero_BXsf_mean62->SetMinimum(-0.02361874);
   Graph_pu0_8b4e_gr_bias_nonzero_BXsf_mean62->SetMaximum(0.1628563);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_BXsf_mean63->SetMinimum(0.02300069);
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_BXsf_mean63->SetMaximum(0.1948422);
   ...
   Graph_pu50s2_8b4e_gr_bias_nonzero_BXsf_mean64->SetMinimum(0.05282034);
   Graph_pu50s2_8b4e_gr_bias_nonzero_BXsf_mean64->SetMaximum(0.2190241);
   ...
   Graph_pu50s30_8b4e_gr_bias_nonzero_BXsf_mean65->SetMinimum(-0.01863686);
   Graph_pu50s30_8b4e_gr_bias_nonzero_BXsf_mean65->SetMaximum(0.1676376);

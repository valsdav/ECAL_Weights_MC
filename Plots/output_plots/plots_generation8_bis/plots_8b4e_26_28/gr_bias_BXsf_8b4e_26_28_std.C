void gr_bias_BXsf_8b4e_26_28_std()
{
...
//=========  (Wed Jul  3 00:46:45 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.4927711,-0.2156937,7.459036,1.443488);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_BXsf_std26->SetMinimum(0.02572902);
   Graph_curr_8b4e_gr_bias_BXsf_std26->SetMaximum(1.407609);
   ...
   Graph_pu0_8b4e_gr_bias_BXsf_std27->SetMinimum(0.02433003);
   Graph_pu0_8b4e_gr_bias_BXsf_std27->SetMaximum(1.411004);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_BXsf_std28->SetMinimum(0.02414947);
   Graph_pu0_newavg_8b4e_gr_bias_BXsf_std28->SetMaximum(1.424039);
   ...
   Graph_pu50s2_8b4e_gr_bias_BXsf_std29->SetMinimum(0.02443959);
   Graph_pu50s2_8b4e_gr_bias_BXsf_std29->SetMaximum(1.353958);
   ...
   Graph_pu50s30_8b4e_gr_bias_BXsf_std30->SetMinimum(0.02471155);
   Graph_pu50s30_8b4e_gr_bias_BXsf_std30->SetMaximum(1.409836);

...
//=========  (Wed Jul  3 00:46:48 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.7415662,-0.3108379,8.535542,1.310992);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_train_std86->SetMinimum(0.07339778);
   Graph_curr_8b4e_gr_train_std86->SetMaximum(0.3922027);
   ...
   Graph_pu0_8b4e_gr_train_std87->SetMinimum(0.07570233);
   Graph_pu0_8b4e_gr_train_std87->SetMaximum(0.3694579);
   ...
   Graph_pu0_newavg_8b4e_gr_train_std88->SetMinimum(0.06137246);
   Graph_pu0_newavg_8b4e_gr_train_std88->SetMaximum(0.4009994);
   ...
   Graph_pu50s2_8b4e_gr_train_std89->SetMinimum(0.07707314);
   Graph_pu50s2_8b4e_gr_train_std89->SetMaximum(0.2914427);
   ...
   Graph_pu50s30_8b4e_gr_train_std90->SetMinimum(0.0750511);
   Graph_pu50s30_8b4e_gr_train_std90->SetMaximum(0.3705841);

void gr_train_BXsf_8b4e_26_28_mean()
{
...
//=========  (Wed Jul  3 00:46:54 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.7415662,-0.4415639,8.535542,0.9970274);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_train_BXsf_mean101->SetMinimum(-0.148711);
   Graph_curr_8b4e_gr_train_BXsf_mean101->SetMaximum(0.2195451);
   ...
   Graph_pu0_8b4e_gr_train_BXsf_mean102->SetMinimum(-0.1843107);
   Graph_pu0_8b4e_gr_train_BXsf_mean102->SetMaximum(0.1728536);
   ...
   Graph_pu0_newavg_8b4e_gr_train_BXsf_mean103->SetMinimum(-0.1516382);
   Graph_pu0_newavg_8b4e_gr_train_BXsf_mean103->SetMaximum(0.2432941);
   ...
   Graph_pu50s2_8b4e_gr_train_BXsf_mean104->SetMinimum(-0.08982525);
   Graph_pu50s2_8b4e_gr_train_BXsf_mean104->SetMaximum(0.3139834);
   ...
   Graph_pu50s30_8b4e_gr_train_BXsf_mean105->SetMinimum(-0.1735365);
   Graph_pu50s30_8b4e_gr_train_BXsf_mean105->SetMaximum(0.1899165);

void gr_bias_nonzero_Asf_8b4e_26_28_std()
{
...
//=========  (Wed Jul  3 00:46:47 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.4927711,-0.1259285,7.459036,0.8500365);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_nonzero_Asf_std56->SetMinimum(0.03720566);
   Graph_curr_8b4e_gr_bias_nonzero_Asf_std56->SetMaximum(0.8372135);
   ...
   Graph_pu0_8b4e_gr_bias_nonzero_Asf_std57->SetMinimum(0.03576185);
   Graph_pu0_8b4e_gr_bias_nonzero_Asf_std57->SetMaximum(0.7906669);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_Asf_std58->SetMinimum(0.03510852);
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_Asf_std58->SetMaximum(0.8327428);
   ...
   Graph_pu50s2_8b4e_gr_bias_nonzero_Asf_std59->SetMinimum(0.03359143);
   Graph_pu50s2_8b4e_gr_bias_nonzero_Asf_std59->SetMaximum(0.6521911);
   ...
   Graph_pu50s30_8b4e_gr_bias_nonzero_Asf_std60->SetMinimum(0.03594546);
   Graph_pu50s30_8b4e_gr_bias_nonzero_Asf_std60->SetMaximum(0.7936508);

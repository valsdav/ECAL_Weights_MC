void gr_bias_totsf_8b4e_26_28_mean()
{
...
//=========  (Wed Jul  3 00:46:46 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.4927711,-0.3301243,7.459036,1.440063);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_totsf_mean31->SetMinimum(0.03117511);
   Graph_curr_8b4e_gr_bias_totsf_mean31->SetMaximum(0.4470539);
   ...
   Graph_pu0_8b4e_gr_bias_totsf_mean32->SetMinimum(0.0002241007);
   Graph_pu0_8b4e_gr_bias_totsf_mean32->SetMaximum(0.3617898);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_totsf_mean33->SetMinimum(0.01375731);
   Graph_pu0_newavg_8b4e_gr_bias_totsf_mean33->SetMaximum(0.3814575);
   ...
   Graph_pu50s2_8b4e_gr_bias_totsf_mean34->SetMinimum(0.09090933);
   Graph_pu50s2_8b4e_gr_bias_totsf_mean34->SetMaximum(0.381726);
   ...
   Graph_pu50s30_8b4e_gr_bias_totsf_mean35->SetMinimum(0.01331271);
   Graph_pu50s30_8b4e_gr_bias_totsf_mean35->SetMaximum(0.38256);

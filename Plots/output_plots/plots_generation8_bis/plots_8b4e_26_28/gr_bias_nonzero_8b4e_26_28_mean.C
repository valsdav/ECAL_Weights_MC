void gr_bias_nonzero_8b4e_26_28_mean()
{
...
//=========  (Wed Jul  3 00:46:46 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.4927711,-0.4501579,7.459036,2.196595);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_bias_nonzero_mean41->SetMinimum(0.02557098);
   Graph_curr_8b4e_gr_bias_nonzero_mean41->SetMaximum(0.6852446);
   ...
   Graph_pu0_8b4e_gr_bias_nonzero_mean42->SetMinimum(-0.05809183);
   Graph_pu0_8b4e_gr_bias_nonzero_mean42->SetMaximum(0.5660498);
   ...
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_mean43->SetMinimum(0.04394479);
   Graph_pu0_newavg_8b4e_gr_bias_nonzero_mean43->SetMaximum(0.6506439);
   ...
   Graph_pu50s2_8b4e_gr_bias_nonzero_mean44->SetMinimum(0.08752916);
   Graph_pu50s2_8b4e_gr_bias_nonzero_mean44->SetMaximum(0.5549186);
   ...
   Graph_pu50s30_8b4e_gr_bias_nonzero_mean45->SetMinimum(0.007591272);
   Graph_pu50s30_8b4e_gr_bias_nonzero_mean45->SetMaximum(0.5842141);

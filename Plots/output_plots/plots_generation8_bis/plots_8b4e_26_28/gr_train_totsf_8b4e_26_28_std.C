void gr_train_totsf_8b4e_26_28_std()
{
...
//=========  (Wed Jul  3 00:46:55 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.7415662,-0.4949136,8.535542,2.542883);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_train_totsf_std116->SetMinimum(0.1186289);
   Graph_curr_8b4e_gr_train_totsf_std116->SetMaximum(0.7510123);
   ...
   Graph_pu0_8b4e_gr_train_totsf_std117->SetMinimum(0.125137);
   Graph_pu0_8b4e_gr_train_totsf_std117->SetMaximum(0.7120932);
   ...
   Graph_pu0_newavg_8b4e_gr_train_totsf_std118->SetMinimum(0.09271286);
   Graph_pu0_newavg_8b4e_gr_train_totsf_std118->SetMaximum(0.7819827);
   ...
   Graph_pu50s2_8b4e_gr_train_totsf_std119->SetMinimum(0.1240008);
   Graph_pu50s2_8b4e_gr_train_totsf_std119->SetMaximum(0.5831107);
   ...
   Graph_pu50s30_8b4e_gr_train_totsf_std120->SetMinimum(0.1234477);
   Graph_pu50s30_8b4e_gr_train_totsf_std120->SetMaximum(0.7151038);

void gr_bias_nonzero_48b7e_22_25_mean()
{
...
//=========  (Wed Jul  3 00:08:37 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.9903614,-0.2508031,9.612048,0.2667364);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_nonzero_mean41->SetMinimum(-0.06717954);
   Graph_curr_48b7e_gr_bias_nonzero_mean41->SetMaximum(0.03108343);
   ...
   Graph_pu0_48b7e_gr_bias_nonzero_mean42->SetMinimum(-0.09169376);
   Graph_pu0_48b7e_gr_bias_nonzero_mean42->SetMaximum(0.006355605);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_mean43->SetMinimum(-0.04920172);
   Graph_pu0_newavg_48b7e_gr_bias_nonzero_mean43->SetMaximum(0.05392643);
   ...
   Graph_pu50s2_48b7e_gr_bias_nonzero_mean44->SetMinimum(-0.02481253);
   Graph_pu50s2_48b7e_gr_bias_nonzero_mean44->SetMaximum(0.08187863);
   ...
   Graph_pu50s30_48b7e_gr_bias_nonzero_mean45->SetMinimum(-0.08721698);
   Graph_pu50s30_48b7e_gr_bias_nonzero_mean45->SetMaximum(0.01141496);

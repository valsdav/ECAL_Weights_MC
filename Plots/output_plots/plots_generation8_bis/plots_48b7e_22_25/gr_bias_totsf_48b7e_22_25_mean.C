void gr_bias_totsf_48b7e_22_25_mean()
{
...
//=========  (Wed Jul  3 00:08:36 2019) by ROOT version 6.16/00
   ...
   c1->Range(-0.9903614,-0.3975178,9.612048,0.2776654);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_totsf_mean31->SetMinimum(-0.1954168);
   Graph_curr_48b7e_gr_bias_totsf_mean31->SetMaximum(0.04296646);
   ...
   Graph_pu0_48b7e_gr_bias_totsf_mean32->SetMinimum(-0.2305148);
   Graph_pu0_48b7e_gr_bias_totsf_mean32->SetMaximum(0.01873534);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_totsf_mean33->SetMinimum(-0.1881546);
   Graph_pu0_newavg_48b7e_gr_bias_totsf_mean33->SetMaximum(0.06774724);
   ...
   Graph_pu50s2_48b7e_gr_bias_totsf_mean34->SetMinimum(-0.1719522);
   Graph_pu50s2_48b7e_gr_bias_totsf_mean34->SetMaximum(0.09626219);
   ...
   Graph_pu50s30_48b7e_gr_bias_totsf_mean35->SetMinimum(-0.2256149);
   Graph_pu50s30_48b7e_gr_bias_totsf_mean35->SetMaximum(0.02377661);

void gr_bias_Asf_48b7e_22_25_std()
{
...
//=========  (Wed Jul  3 00:08:36 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.9903614,-0.2680692,9.612048,1.794002);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_48b7e_gr_bias_Asf_std16->SetMinimum(0.0112193);
   Graph_curr_48b7e_gr_bias_Asf_std16->SetMaximum(1.759145);
   ...
   Graph_pu0_48b7e_gr_bias_Asf_std17->SetMinimum(0.005928377);
   Graph_pu0_48b7e_gr_bias_Asf_std17->SetMaximum(1.771103);
   ...
   Graph_pu0_newavg_48b7e_gr_bias_Asf_std18->SetMinimum(0.009199183);
   Graph_pu0_newavg_48b7e_gr_bias_Asf_std18->SetMaximum(1.720351);
   ...
   Graph_pu50s2_48b7e_gr_bias_Asf_std19->SetMinimum(0.01976107);
   Graph_pu50s2_48b7e_gr_bias_Asf_std19->SetMaximum(1.702844);
   ...
   Graph_pu50s30_48b7e_gr_bias_Asf_std20->SetMinimum(0.006409747);
   Graph_pu50s30_48b7e_gr_bias_Asf_std20->SetMaximum(1.767097);

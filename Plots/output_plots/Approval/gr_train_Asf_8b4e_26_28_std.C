void gr_train_Asf_8b4e_26_28_std()
{
...
//=========  (Wed Jul  3 00:46:54 2019) by ROOT version 6.16/00
   ...
   c2->Range(-0.7415662,-0.4940957,8.535542,2.53741);
   c2->SetFillColor(0);
   c2->SetBorderMode(0);
   c2->SetBorderSize(2);
   c2->SetGridy();
   ...
   Graph_curr_8b4e_gr_train_Asf_std96->SetMinimum(0.1204139);
   Graph_curr_8b4e_gr_train_Asf_std96->SetMaximum(0.7487163);
   ...
   Graph_pu0_8b4e_gr_train_Asf_std97->SetMinimum(0.1268691);
   Graph_pu0_8b4e_gr_train_Asf_std97->SetMaximum(0.7100588);
   ...
   Graph_pu0_newavg_8b4e_gr_train_Asf_std98->SetMinimum(0.09443921);
   Graph_pu0_newavg_8b4e_gr_train_Asf_std98->SetMaximum(0.7801202);
   ...
   Graph_pu50s2_8b4e_gr_train_Asf_std99->SetMinimum(0.1255162);
   Graph_pu50s2_8b4e_gr_train_Asf_std99->SetMaximum(0.5820962);
   ...
   Graph_pu50s30_8b4e_gr_train_Asf_std100->SetMinimum(0.125166);
   Graph_pu50s30_8b4e_gr_train_Asf_std100->SetMaximum(0.7130894);

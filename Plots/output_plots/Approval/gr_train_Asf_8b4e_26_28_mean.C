...
//=========  (Sat Jun 29 12:05:55 2019) by ROOT version 6.16/00
   TCanvas *c1 = new TCanvas("c1", "c1",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->SetHighLightColor(2);
   c1->Range(-0.7415662,-1.037905,8.535542,4.022625);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridy();
   ...
   Graph_curr_8b4e_gr_train_Asf_mean91->SetMinimum(-0.3705929);
   Graph_curr_8b4e_gr_train_Asf_mean91->SetMaximum(1.123863);
   ...
   Graph_pu0_8b4e_gr_train_Asf_mean92->SetMinimum(-0.3959044);
   Graph_pu0_8b4e_gr_train_Asf_mean92->SetMaximum(0.9945173);
   ...
   Graph_pu0_newavg_8b4e_gr_train_Asf_mean93->SetMinimum(-0.3828653);
   Graph_pu0_newavg_8b4e_gr_train_Asf_mean93->SetMaximum(1.209746);
   ...
   Graph_pu50s2_8b4e_gr_train_Asf_mean94->SetMinimum(-0.3219481);
   Graph_pu50s2_8b4e_gr_train_Asf_mean94->SetMaximum(1.023099);
   ...
   Graph_pu50s30_8b4e_gr_train_Asf_mean95->SetMinimum(-0.3896794);
   Graph_pu50s30_8b4e_gr_train_Asf_mean95->SetMaximum(1.02203);
